...
import com.alexeykadilnikov.security.JwtAuthenticationEntryPoint;
import com.alexeykadilnikov.security.JwtRequestFilter;
...
@Configuration
@ComponentScan(basePackages = "com.alexeykadilnikov")
@EnableWebSecurity
